...
% This function implements the parametric model of a Peltier Cell 
...
%
function [sys,x0,str,ts] = Peltier_Block(t,x,u,flag)
...
x0 = [25 25 25]'; % Initial conditions.
